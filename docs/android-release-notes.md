...
0.1.23 -> 0.1.29 fleet update.

## Current production release

- Current production endpoint: `https://www.sellermate.ai.kr/android/app-release/latest`
- Current APK: `https://www.sellermate.ai.kr/downloads/android/naver-traffic-samsung-0.1.29-v30-release.apk`
- Current package: `com.navertraffic.samsung`
- Current version: `versionName=0.1.29`, `versionCode=30`
- Current APK SHA256: `c880f70d644c112f9ffeb4c6d52aff551511718538577b0452a4e6fe5a158953`
...
| 0.1.29 | 30 | Current production | Routes Naver Shopping tasks by product-scoped strategy assignment: unassigned stays on default G, while A/B/C run in the same APK from task lease metadata. |
